...
export const inject = ['systemPrompt', 'httpServer'];
 ...
 * @param ctx - plugin context carrying systemPrompt and httpServer.
 */
export function apply(ctx) {
  const webUrl = `http://127.0.0.1:${String(ctx.httpServer.port)}`;
  ctx.effect(
